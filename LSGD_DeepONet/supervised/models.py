...
#### Hyperparams
## Advection IC, Diffusion-Reaction: C = 100, L = 3
## Advection a, g(BC): C = 150, L = 3
## Burgers: C = 200, L = 4
## Poisson kappa: Trunk: C = 150, L = 3, Branch: (32,32,1)-> (16,16,16)-> (8,8,32)-> (4,4,64)-> Flatten 1024 -> 150 (LL in) -> 150 (LL out)
...
# branch_layers_CNN = [[16,(3,3),(2,2),'VALID'],[32,(2,2),(2,2),'VALID'],[64,(2,2),(2,2),'VALID']] # CNN part for 2D branch network with CNN (Example with Poisson f)
# branch_layers_MLP = [C] * (1) # FCN part for 2D branch network with CNN (Example with Poisson f)
...
branch_model =  MLP(*model_settings[0]) # CNN_MLP(*model_settings[0])
