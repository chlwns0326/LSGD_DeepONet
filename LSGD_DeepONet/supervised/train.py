...
def train(params, optimizer, delay_init,
    ...
    for wu in tqdm(range(nIter)):
        ...
        if (wu+1) in saveWU or wu+1 == nIter:
            ...
            ## jnp.save(model_dir+'/losses/training_loss_iter',loss_iter_val) # data per iteration, commented out (##) due to huge memory/time
        ...
        if wu > 0 and losses[0] < min_loss:
            ...
            if nIter < 20 or wu+1 > 20-1:
                ...
                echstr = str(min(i for i in saveWU if i >= wu+1))
