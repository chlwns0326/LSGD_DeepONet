...
# Directories
model_dir = 'unsupervised/Advection_IC/Models/Advection_PI_IC_PQ_LSAdam_100_HH_SS_bat50_L3W100_phy_1e-1_regul_1e-6' #
data_dir = 'data/' + 'Advection_PQ_data' 
...
# Initialize
m = Nx+Ny+1  # number of trunk input sensors
